...
<div class="min-h-screen flex items-center justify-center p-4 relative">
  ...
  <div class="fixed inset-0 w-full h-full">
    <img src="{{ asset('images/event-bg.jpg') }}" class="w-full h-full object-cover" alt="Event background">
  ...
  <div class="glass-card p-10 pt-8 rounded-3xl w-[650px] min-h-[550px] flex flex-col shadow-xl relative z-10">
      ...
      <!-- Back Button -->
      <a href="{{ route('custom-event.venue') }}" class="absolute top-4 left-4 text-purple-900 hover:text-indigo-400 font-semibold transition">
          &#8592; Go Back
      </a>
      ...
      <div class="w-full mb-8">
          <div class="flex items-center justify-between text-sm font-medium text-blue-900 mb-2">
              ...
              <span class="font-bold text-purple-600">Step 2: Seating</span>
          ...
          <div class="w-full bg-white/30 rounded-full h-2 overflow-hidden">
              <div class="bg-gradient-to-r from-indigo-500 to-purple-500 h-2 rounded-full" style="width: 40%;"></div>
          </div>
      </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Get max attendees based on venue
    ...
    function calculateCost() {
        ...
        const chairCost = chairTypeSelect.value === 'premium' ? 10 : (chairTypeSelect.value === 'luxury' ? 20 : 5);
        const tableCost = tableTypeSelect.value === 'square' ? 15 : 10;
        const seatCoverCost = seatCoverSelect.value === 'yes' ? 5 : 0;
        ...
        const seatingData = {
            attendees: attendees,
            chairType: chairTypeSelect.value,
            tableType: tableTypeSelect.value,
            seatCover: seatCoverSelect.value,
            cost: totalCost
        };
