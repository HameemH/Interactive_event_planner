...
<div class="min-h-screen flex items-center justify-center p-4 relative">
  ...
  <div class="glass-card p-10 pt-8 rounded-3xl w-[650px] min-h-[600px] flex flex-col shadow-xl relative z-10">
      ...
      <!-- Back Button -->
      <a href="{{ route('customize.seating') }}" class="absolute top-4 left-4 text-purple-900 hover:text-indigo-400 font-semibold transition">
          &#8592; Go Back
      </a>
...
<!-- Progress Bar -->
    ...
    <div class="w-full bg-white/30 rounded-full h-2 overflow-hidden">
      ...
      <div class="space-y-6">
        ...
        <!-- Submit Button -->
        <div>
          <a href="{{ route('customize.catering') }}" class="block w-full py-3 rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold hover:scale-105 transition transform shadow-lg text-center">
...
<div id="decoration-slider" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
  <div class="bg-white p-6 rounded-lg w-[80%] md:w-[60%]">
      <h3 class="text-xl font-semibent text-gray-800 mb-4">Select Decoration Image</h3>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateTotalEstimatedCost() {
        ...
        totalEstimatedCostEl.innerText = `Total Estimated Price: $${total}`;
    }
    ...
    function updateCost() {
        ...
        const stageData = {
            ...
            stage_image: stageImageInput.value,
            decoration: surroundingCheckbox.checked,
            decoration_image: decorationImageInput.value,
            cost: totalCost
        };
